...
class WebhookSetup:
    def __init__(self):
        self.zapi_instance_id = os.getenv("ZAPI_INSTANCE_ID", "VARIABLE_FROM_ENV")
        self.zapi_token = os.getenv("ZAPI_TOKEN", "VARIABLE_FROM_ENV")
        self.zapi_client_token = os.getenv("ZAPI_CLIENT_TOKEN", "VARIABLE_FROM_ENV")
